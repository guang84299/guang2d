...
(function(g){
    ...
    g.kmMat3 = g.math.Matrix3;
    var proto = g.math.Matrix3.prototype;

    proto.fill = function(mat3) {            //g.kmMat3Fill
    ...
    proto.adjugate = function(){   //= g.kmMat3Adjugate
        var mat = this.mat;
    ...
    proto.identity = function() { //g.kmMat3Identity
        var mat = this.mat;
        mat[1] = mat[2] = mat[3] =
            mat[5] = mat[6] = mat[7] = 0;
    ...
    var tmpMatrix = new g.math.Matrix3();          // internal matrix

    proto.inverse = function(determinate){         //g.kmMat3Inverse
        if (determinate === 0.0)
            return this;
    ...
    proto.isIdentity = function(){    //= g.kmMat3IsIdentity
        var mat = this.mat;
    ...
    proto.transpose = function(){     // g.kmMat3Transpose
        var mat = this.mat;
    ...
    g.math.Matrix3.rotationAxisAngle = function(axis, radians) {    //g.kmMat3RotationAxisAngle
        var rcos = Math.cos(radians), rsin = Math.sin(radians);
        var retMat = new g.math.Matrix3();
        var mat = retMat.mat;
    ...
    proto.assignFrom = function(matIn){      // g.kmMat3Assign
        if(this === matIn) {
            g.log("g.math.Matrix3.assign(): current matrix equals matIn");
            return this;
        }
    ...
    proto.equals = function(mat3) {
        if (this === mat3)
            return true;
        var EPSILON = g.math.EPSILON,m1 = this.mat, m2 = mat3.mat;
        for (var i = 0; i < 9; ++i) {
    ...
    g.math.Matrix3.createByRotationX = function(radians) {
        var retMat = new g.math.Matrix3(), mat = retMat.mat;
        mat[0] = 1.0;
        mat[1] = 0.0;
        mat[2] = 0.0;
    ...
    g.math.Matrix3.createByRotationY = function(radians) {
        /*
         |  cos(A)  0   sin(A) |
         M = |  0       1   0      |
         | -sin(A)  0   cos(A) |
    ...
    g.math.Matrix3.createByRotationZ = function(radians) {
        /*
         |  cos(A)  -sin(A)   0  |
         M = |  sin(A)   cos(A)   0  |
         |  0        0        1  |
    ...
    g.math.Matrix3.createByRotation = function(radians) {
        /*
         |  cos(A)  -sin(A)   0  |
         M = |  sin(A)   cos(A)   0  |
         |  0        0        1  |
    ...
    g.math.Matrix3.createByScale = function(x, y) {
        var ret = new g.math.Matrix3();
        ret.identity();
        ret.mat[0] = x;
        ret.mat[4] = y;
        return ret;
    ...
    g.math.Matrix3.createByTranslation = function(x, y){
        var ret = new g.math.Matrix3();
        ret.identity();
        ret.mat[6] = x;
        ret.mat[7] = y;
    ...
    g.math.Matrix3.createByQuaternion = function(quaternion) {     //g.kmMat3RotationQuaternion
        if(!quaternion)
            return null;

        var ret = new g.math.Matrix3(), mat = ret.mat;
        // First row
    ...
    proto.rotationToAxisAngle = function() {           //g.kmMat3RotationToAxisAngle
        return g.math.Quaternion.rotationMatrix(this).toAxisAndAngle();
    }
})(g);
